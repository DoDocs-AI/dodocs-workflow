...
2. **Scan ALL manual test case files project-wide**:
   ...
   - Identify test steps that reference modified UI elements, changed URLs/routes, changed API responses, removed/renamed features
...
3. **Scan ALL Playwright E2E spec files project-wide**:
   ...
   - Identify specs that reference modified selectors, changed URLs, changed API patterns, modified assertions
